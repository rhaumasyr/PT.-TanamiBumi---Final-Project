...
proc casutil;
  Load casdata="79236 - Rhauma Syira - Gradient_boosting___Crop_1.sashdat" incaslib="Models" casout="79236 - Rhauma Syira - Gradient_boosting___Crop_1" outcaslib="casuser" replace;
Quit;
...
proc cas;
  ...
  routineCode = "
   ...
   Generated SAS Scoring Code
     ...
     ------------------------------------------*/
declare object 79236 - Rhauma Syira - Gradient_boosting___Crop_1(astore);
call 79236 - Rhauma Syira - Gradient_boosting___Crop_1.score('CASUSER','79236 - Rhauma Syira - Gradient_boosting___Crop_1');
   /*------------------------------------------*/
   /*_VA_DROP*/ drop 'I_Crop'n 'P_CropCoconut'n 'P_CropPotato'n 'P_CropRice'n 'P_CropSugarcane'n 'P_CropWheat'n;
length 'I_Crop_171'n $21;
      'I_Crop_171'n='I_Crop'n;
'P_CropCoconut_171'n='P_CropCoconut'n;
'P_CropPotato_171'n='P_CropPotato'n;
'P_CropRice_171'n='P_CropRice'n;
'P_CropSugarcane_171'n='P_CropSugarcane'n;
'P_CropWheat_171'n='P_CropWheat'n;
   /*------------------------------------------*/
";
